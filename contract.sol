...
/**
 * Website: tokenheaven.finance
 * Channel Telegram: https://t.me/TokenHeaven
 * Discussion Group: https://t.me/joinchat/4CgOqAN4maJiNmQ8
 * 
...
/** 
 * Contract: Heaven Token
 * Developed By: SafemoonMark
 * 
 * Liquidity-less Token, DEX built into Contract
 * Send BNB to contract and it mints Heaven Token to your receive Address
 ...
 * 
 */
contract HeavenToken is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    /** Purchases Heaven Tokens and Deposits Them in Sender's Address*/
    function purchase(address buyer, uint256 bnbAmount) internal returns (bool) {
        ...
        // revert if under 1
        if (tokensToSend < 1) {
            revert('Must Buy More Than One Heaven');
        }
    ...
    /** Sells Heaven Tokens And Deposits the BNB into Seller's Address */
